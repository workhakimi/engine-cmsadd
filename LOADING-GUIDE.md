...
### Component doesn’t appear in the Add panel

- Confirm you’re using **Open Dev Editor** for local dev
- Confirm the dev server is running (`npm run serve`)
- Confirm you clicked **Add local Element** and entered the correct port
- Try clearing “Local Development” in the Dev panel and adding the element again

### Component appears but nothing happens when dragging

- Check the browser console (F12) for errors
- Ensure Node.js is >= 18 (`node -v`)
- Try a different port: `npm run serve -- port=4040`

### SSL / certificate errors

- Visit https://localhost:8080 directly and accept the certificate
- Use Chrome and enable “Allow invalid certificates for localhost” if needed
